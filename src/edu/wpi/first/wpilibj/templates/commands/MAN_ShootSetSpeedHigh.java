 ...
 *
 * @author Pat Godard
 * Manual override for setting the shoot speed high, ignores all sensors
 * ALL MANUAL OVERRIDE METHODS CAN BREAK THE ROBOT USE WITH CAUTION
 */
public class MAN_ShootSetSpeedHigh extends CommandBase {
    
    private boolean speedControlCheck = score.isSpeedControl();
    
    public MAN_ShootSetSpeedHigh() {
    ...
    /**
     * Turns on the motor to high speed
     */
    protected void execute() {
        System.out.println("Setting Shooter High" + oi.getShooterHighButton());
        score.setSpeed(7); //TODO: find proper speed
    ...
    protected boolean isFinished() {
        return !oi.getShooterHighButton();
    }
