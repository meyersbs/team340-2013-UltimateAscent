 ...
 */
public class CG_AutonomousTimedHi extends CommandGroup 
{
    /**
     *
     */
    public CG_AutonomousTimedHi() 
    {
        addSequential(new WT_ResetGyro());
        addParallel(new WT_ShiftWeightBackward());
        addParallel(new CLIMB_GoToBottomLimit());
        addSequential(new AUTO_TimedGo(-0.6,0,7));
        //addSequential(new AUTO_TimedGo(-.3, 0, 2));
        addSequential(new SHOOT_SetHighGoal());
        addSequential(new NOTHING(), 2);
