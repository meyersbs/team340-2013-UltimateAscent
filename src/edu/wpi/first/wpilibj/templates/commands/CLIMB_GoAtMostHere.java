 ...
 */
public class CLIMB_GoAtMostHere extends CommandBase {
     ...
     */
    public CLIMB_GoAtMostHere(double speed,double encoderValue, double tol) {
        requires(climb);
        motorSpeed = speed;
        tolerance = tol;
    ...
    protected void initialize() {
        System.out.println("GoAtMostHere");
    }
    ...
    protected void execute() {
        ...
        System.out.println("GoAtMostHere; Encoder: " + climb.getArmEncoderValue());
